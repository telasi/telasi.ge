...
function moveshadow(mPos){
  // shadow.style.position = "absolute";
  shadow.style.left = mPos.x+'px';
  shadow.style.top = mPos.y+'px';
}
...
function TableDnD() {
    ...
    this.init = function(table) {
        ...
        for (var i=0; i<rows.length; i++) {
            ...
            // var subrows = rows[i].cells[0].firstChild.nextSibling.tBodies[0].rows;
            // if (subrows != null){
            //    for (var k=0; k<subrows.length; k++) {
            //      this.makeDraggable(subrows[k]);
            //    }
